...
asciiIO_t& asciiIO_t::operator>>(short& num){return Read(num, "%d");}
asciiIO_t& asciiIO_t::operator<<(short num){return Write(num, "%d");}
...
asciiIO_t& asciiIO_t::operator>>(unsigned int& num){return Read(num, "%d");}
asciiIO_t& asciiIO_t::operator<<(unsigned int num){return Write(num, "%d");}
